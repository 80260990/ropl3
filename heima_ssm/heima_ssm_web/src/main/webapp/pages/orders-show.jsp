        ...
        <section class = content>
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-2 title">出发人数</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="出发人数"
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                        <c:forEach items="${orders.travellers}" var="t">
                            <tr>
                                <td><input name="ids" type="checkbox"></td>
                                <td class="text-center">${t.id}</td>
                                <td class="text-center">${t.travellerName}</td>
                                <td class="text-center">${t.travellerSex}</td>
                                <td class="text-center">${t.travellerPhone}</td>
                                <td class="text-center">${t.travellerIdType}</td>
                                <td class="text-center">${t.travellerIdNum}</td>
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="会员"
                               value="${orders.member.memberNum}" readonly="readonly"/>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="联系人"
                               value="${orders.member.memberName}" readonly="readonly"/>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="手机号"
                               value="${orders.member.memberPhone}" readonly="readonly"/>
                    </div>

                    <div class="col-md-2 title">邮箱</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="邮箱"
                               value="${orders.member.memberEmail}" readonly="readonly"/>
                    </div>
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="支付方式"
                               value="在线支付-${orders.payTypeStr}" readonly="readonly"/>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="金额"
                               value="${orders.product.productPrice}" readonly="readonly"/>
                    </div>
