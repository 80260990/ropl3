...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>产品管理<span>全部产品</span></h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/main.jsp"><i
                        class="fa fa-dashboard"></i>首页</a></li>
                <li><a href="${pageContext.request.contextPath}/orders/findAll.do">产品管理</a></li>
                <li class="active">编辑产品</li>
            </ol>
        </section>


        <form action="${pageContext.request.contextPath}/product/updateById.do" method="post">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="产品id" name="id"
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control"
                               placeholder="出发城市" name="cityName"
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group">
                            ...
                            <div class='input-group date' id='datetimepicker2'>
                                <input type='text' class="form-control pull-right" name="departureTimeStr"
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control select2 setSelected" name="productStatus">
...
<script>
    $(document).ready(function() {
        ...
        $(".setSelected").children("option").get(parseInt(${product.productStatus})).selected=true;
